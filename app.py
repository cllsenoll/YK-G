...
# ==========================================
# TEMEL YARDIMCI & PARSE FONKSİYONLARI
# ==========================================
...
def get_courier_photo(courier_name):
    ...
    return f"https://ui-avatars.com/api/?name={str(courier_name).replace(' ', '+')}&background=0B172E&color=F57C00&bold=true&size=80"
...
if st.session_state.active_tab == "Ana Panel":
    ...
    if perf_df is not None and not perf_df.empty:
        ...
        st.info("💡 Sol menüden **AT ZİMMET İZLEME** veya **PERSONEL HESAP ALIMI** dosyanızı yükleyerek paneli kullanabilirsiniz.")
...
# ==========================================
    ...
    if active_account_df is not None:
        if "hesap_df" not in st.session_state or st.sidebar.button("🔄 Tabloyu Sıfırla"):
            st.session_state.hesap_df = active_account_df.copy()
        ...
        st.info("💡 Lütfen sol taraftan **PERSONEL HESAP ALIMI** (Ödeme Listesi) dosyanızı yükleyin.")
